...
test("writeString and readString", () => {
    let target = Buffer.from("01234567890abcdef01234567890abcdef", "hex")
    ...
    target = Buffer.from("01234567890abcdef01234567890abcdef", "hex")
...
test("writeUInt24BE and readUInt24BE", () => {
    ...
    const target = Buffer.from("0123456789abcdef", "hex");
