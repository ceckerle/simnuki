...
import {CMD_ENABLE_DOOR_SENSOR_LOGGING, ERROR_BAD_LENGTH} from "./Constants";
import {DecodingError} from "./DecodingError";

export class EnableDoorSensorLoggingCommand extends CommandNeedsSecurityPin {
    
    readonly id = CMD_ENABLE_DOOR_SENSOR_LOGGING;
    enabled: boolean;
    nonce: Buffer;
    securityPin: number;
    ...
    toString(): string {
        let str = "EnableDoorSensorLoggingCommand {";
