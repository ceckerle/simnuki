...
export const PAIRING_GDIO_CHARACTERISTIC = 0x101;
export const KEYTURNER_GDIO_CHARACTERISTIC = 0x201;
...
export const HOMEKIT_STATUS_UNAVAILABLE = 0x00;
export const HOMEKIT_STATUS_DISABLED = 0x01;
export const HOMEKIT_STATUS_ENABLED = 0x02;
export const HOMEKIT_STATUS_PAIRED = 0x03;

export const DOOR_SENSOR_STATE_UNAVAILABLE = 0x00;
export const DOOR_SENSOR_STATE_DEACTIVATED = 0x01;
export const DOOR_SENSOR_STATE_CLOSED = 0x02;
export const DOOR_SENSOR_STATE_OPENED = 0x03;
export const DOOR_SENSOR_STATE_UNKNOWN = 0x04;
export const DOOR_SENSOR_STATE_CALIBRATING = 0x05;
