...
const serverPrivateKey = new Buffer("e7b0ed4e3fd53beb1ace91475b4a9eabc4d7c47f19c84193ebddac953ff9bc45", "hex");
const serverPublicKey = new Buffer("0d4105dbc4dd1e9ff474bd28ef9539b1b0b09fa5444c0d1adabc590f4b5e2e56", "hex");
const clientPrivateKey = new Buffer("4122ac9fd03aed655010583c279507577981fa6738a90a16fb05a87475954ba4", "hex");
const clientPublicKey = new Buffer("76541d1e8bddfa8bb545e5172734c35653761ccbddc5536ef5bf544bde99b427", "hex");
const sharedKey = new Buffer("fadc14fc1cbb2813e0c5bc29b9411370a76b85e3983783aadfa1f11c5aa6aa25", "hex");
const plain = new Buffer("1234567890abcdef", "hex");
const nonce = new Buffer("8c34a5503c40cfae7184b296f58fbaa2f6f9d3ccff58f103", "hex");
const encrypted = new Buffer("e0c19497e5e8dc6d1f444ffb1efebca6a977b136f5846e18", "hex");
const hmac = new Buffer("7d5dac4faf9dae6a1e18d9a62e31137f187c920a389a828602d86ba234362285", "hex");
